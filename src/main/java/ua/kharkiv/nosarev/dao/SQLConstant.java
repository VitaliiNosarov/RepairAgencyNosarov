...
public class SQLConstant {
    ...
    public static final String GET_ORDER_BY_ID = "SELECT b.id, b.price, b.customer_comment, b.creating_time," +
            " b.master_account_id, b.order_status, b.user_account_id, s.id, s.name from booking AS b " +
    ...
    public static final String INSERT_ORDER = "INSERT INTO booking (user_account_id, customer_comment) VALUES (?, ?);";
